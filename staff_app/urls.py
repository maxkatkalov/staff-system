...
clientarea_urlpatterns = [
    ...
    path("company-detail/<int:pk>/departments/create", DepartmentCreateView.as_view(), name="department-create"),
    path("company-detail/<int:pk>/departments/", DepartmentListView.as_view(), name="department-list"),
    path("company-detail/<int:pk>/departments/<int:id>/", DepartmentDetailView.as_view(), name="department-detail"),
    path("company-detail/<int:pk>/departments/<int:id>/update/", DepartmentUpdateView.as_view(), name="department-update"),
